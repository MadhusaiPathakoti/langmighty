...
// these headers. Wildcard is safe here: the credit gate (see creditGate.js)
// no longer uses cookies for auth, so there's no ambient credential a
// wildcard origin could leak — only an Authorization/X-Anon-Id header the
// client explicitly attaches itself.
//
