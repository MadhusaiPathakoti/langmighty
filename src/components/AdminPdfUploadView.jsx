    ...
    try {
      ...
      const finalizeRes = await apiFetch("/api/pdf-store/admin", {
        ...
        body: JSON.stringify({
          ...
          previewPageCount: Number(previewPageCount),
          originalStoragePath: urlData.path,
        }),
      });
    ...
    <div className="relative z-10 flex-1 overflow-y-auto px-4 sm:px-6 py-6">
      <div className="max-w-lg mx-auto space-y-4">
        ...
        <form onSubmit={handleFormSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm text-gray-600 dark:text-gray-300 mb-1">Random preview pages</label>
            <input
              type="number"
              min="1"
              required
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
          <div className="max-w-sm w-full rounded-2xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-6">
            ...
            <dl className="mt-4 space-y-2 text-sm">
              ...
              <div className="flex justify-between gap-3">
                <dt className="text-gray-500 dark:text-gray-400">Preview pages</dt>
                <dd className="text-gray-900 dark:text-gray-100 text-right">{previewPageCount}</dd>
              </div>
              <div className="flex justify-between gap-3">
